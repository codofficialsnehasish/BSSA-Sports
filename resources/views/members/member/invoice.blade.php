                                        ...
                                        <div class="container">
                                            ...
                                            <div class="invo-car-book-wrap1 pt-40">
												...
												<div class="invo-book-detail detail-col-car1">
                                                    ...
                                                    <p><strong>Received with thanks from
                                                            {{ $member_transaction->member->full_name }}</strong></p>
                                                    <p><strong>Date -
                                                            {{ format_date($member_transaction->created_at) }}</strong></p>
                                                    <p><strong>Receipt No. - {{ $member_transaction->memo_no }}</strong></p>
                                                </div>
                                            </div>
                  ...
                  <tr class="tax-row bottom-border">
                   ...
                   <td class="font-md-grey color-grey text-right">$923.40</td>
                                            ...
                                            <div class="d-flex " style="justify-content: space-between">
                                                <p style="text-align: left;color:black;">Rupees
                                                    {{ numberToWords($member_transaction->amount) }} only</p>
                                            ...
                                            <div class="col-lg-12 d-flex">
                                                ...
                                                <div class="col-lg-6">
                                                    <p style="text-align: right;color:black;text-align:center; padding-left:100PX;">Authorized
                                                        signature</p>
                                                </div>
                                            </div>
                                        </div>
