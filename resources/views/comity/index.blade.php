        ...
        <div class="row g-3">
            ...
            <div class="col-auto">
                ...
                <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                    <a href="{{ route('admin.comity.create') }}"><button class="btn btn-primary px-4"><i
                                class="bi bi-plus-lg me-2"></i>Add New Committe</button></a>
                </div>
                                    ...
                                    @if ($comites->isNotEmpty())
                                        ...
                                        @foreach ($comites as $item)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('admin.committe.members.create', $item->id) }}"
                                                        class="btn btn-outline-success">Asign Members</a></td>
                                                <td>{{ \Carbon\Carbon::parse($item->created_at)->format('M d, Y h:i A') }}
                                                </td>
                                                <td>

                                                    <a href="{{ route('admin.comity.edit', $item->id) }}">
