                ...
                <div class="card-body">
                    ...
                    <div id="printableArea" class="table-responsive">
                        <div class="text-center">
                            ...
                            <p style="font-size:18px;">Account Statement, FOR THE PERIOD ENDED FROM {{ \Illuminate\Support\Carbon::parse($startDate)->format('d.m.Y') }} TO {{ \Illuminate\Support\Carbon::parse($endDate)->format('d.m.Y') }}</p>
                        </div>
