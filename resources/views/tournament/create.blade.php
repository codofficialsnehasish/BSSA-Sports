                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="tournament_name" placeholder="Enter Tournament Name" name="tournament_name" value="" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" id="tournament_date" placeholder="Enter Tournament Date" name="tournament_date" value="" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" id="registration_start_date" placeholder="Enter Registration Start Date" name="registration_start_date" value="" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" id="registration_end_date" placeholder="Enter Registration End Date" name="registration_end_date" value="" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="entry_fee" placeholder="Enter Entry Fee" name="entry_fee" value="" required step="0.01">
                                        <div class="invalid-feedback">
