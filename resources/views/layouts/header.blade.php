...
<header class="top-header">
    <nav class="navbar navbar-expand align-items-center gap-4">
        ...
        <ul class="navbar-nav ms-auto gap-1 nav-right-links align-items-center">
            ...
            <a class="d-none nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" data-bs-auto-close="outside"
                ...
                <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
                    <a class="dropdown-item  gap-2 py-2" href="javascript:;">
                        ...
                        <img src="{{ asset('assets/images/avatars/11.png') }}" class="rounded-circle p-1 shadow mb-3" width="90" height="90"
                            alt="">
                        <h5 class="user-name mb-0 fw-bold">Hello, {{ get_role(Auth::id()) }}</h5>
                        </div>
                    </a>
                    <hr class="dropdown-divider">
                    {{-- <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="javascript:;"><i
                        class="material-icons-outlined">person_outline</i>Profile</a> --}}
                    <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('change-password') }}">
