@extends('layouts.app')
    ...
    @section('title') Assign Permissions @endsection
    ...
    <div class="main-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <a class="btn btn-primary px-4" href="{{ route('roles.index') }}"><i class="fadeIn animated bx bx-arrow-back"></i>Back</a>
            </div>
        </div>
        <!--end breadcrumb-->
        ...
        <div class="card mt-4">
            <div class="card-body">
                <form class="custom-validation" action="{{ url('admin/roles/'.$role->id.'/give-permissions') }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="">
