		...
		<div class="ps-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					...
					<li class="breadcrumb-item active" aria-current="page">Income Invoice</li>
				</ol>
			</nav>
		</div>
		<div class="ms-auto">
											...
											<table class="invoice-table student-invoice">
												...
												<tbody class="invo-tb-body">
													<tr class="invo-tb-row">
														<td class="font-sm">{{ $asset->category->name }}</td>
				
														<td class="font-sm">₹{{ $asset->amount }}</td>
													</tr>
												</tbody>
											</table>
												...
												<table class="invo-total-table">
													<tbody>
														...
														<tr class="invo-grand-total bottom-border">
															...
															<td class="font-18-500 color-light-black text-right pt-20">₹{{ $asset->amount }}</td>
														</tr>
													</tbody>
												</table>
											</div>
