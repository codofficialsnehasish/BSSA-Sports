...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <a href="{{ route('tournament-category.create') }}">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example2" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @if ($tournament_category->isNotEmpty())
                                    @foreach ($tournament_category as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('tournament-category.edit', $item->id) }}"> <i class="text-primary" data-feather="edit"></i></a>
                                                <form action="{{ route('tournament-category.destroy', $item->id) }}" onsubmit="return confirm('Are you sure?')" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
