...
@section('title') Fees Collection History @endsection
...
<div class="page-titles">
    <div class="d-flex align-items-center">
        <h5 class="font-medium m-b-0">Admission Fees Collection History</h5>
        <div class="custom-breadcrumb ml-auto">
            <a href="{{ route('dashboard') }}" class="breadcrumb">Home</a>
            <a href="{{ route('admission.index') }}" class="breadcrumb">Admission</a>
            <a href="javascript:void(0);" class="breadcrumb">Admission Fees Collection History</a>
        </div>
    </div>
</div>
<!-- ============================================================== -->
