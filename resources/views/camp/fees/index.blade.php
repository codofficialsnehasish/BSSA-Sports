...
<div class="page-titles">
    <div class="d-flex align-items-center">
        ...
        <div class="custom-breadcrumb ml-auto">
            ...
            <a href="{{ route('fees.index') }}" class="breadcrumb">Admission</a>
            <a href="javascript:void(0);" class="breadcrumb">Admission Fees Collections</a>
        </div>
    </div>
</div>
<!-- ============================================================== -->
        ...
        <div class="col s12">
            <div class="card">
                <div class="card-content">
                    <a href="{{ route('admission.create-fees-collection') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add New</a>
