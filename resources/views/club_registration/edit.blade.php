...
@section('content')
    ...
    <div class="main-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Update Club</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="row">
            <form class="row g-3 needs-validation" novalidate action="{{ route('club-registration.update',$club_registration->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="club_name" placeholder="Enter Club Name" name="club_name" value="{{ $club_registration->club_name }}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="contact_no" placeholder="Enter Contact Number" name="contact_no" value="{{ $club_registration->contact_no }}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <textarea type="date" class="form-control" id="club_address" placeholder="Enter Club Address" name="club_address"> {{ $club_registration->club_address }} </textarea>
                                        <div class="invalid-feedback">
                                        ...
                                        <select class="form-select" id="district_id" name="district_id" required>
                                            ...
                                            @foreach ($districts as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $club_registration->district_id == $item->id ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
