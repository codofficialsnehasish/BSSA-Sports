...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="row">
            <form class="row g-3 needs-validation" novalidate action="{{ route('tournament-category.update',$tournament_category->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="card-body p-4">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="customRadioInline1" name="status" class="form-check-input" value="1" {{ check_uncheck($tournament_category->status,1) }}>
                                        <label class="form-check-label" for="customRadioInline1">Active</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="customRadioInline2" name="status" class="form-check-input" value="0" {{ check_uncheck($tournament_category->status,0) }}>
