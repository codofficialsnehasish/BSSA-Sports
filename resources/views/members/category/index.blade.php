        ...
        <div class="row g-3">
            ...
            <div class="col-auto">
                ...
                <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                    <a href="{{ route('admin.member_category.create') }}"><button class="btn btn-primary px-4"><i
                                    ...
                                    @foreach ($categories as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <p
                                                        class="dash-lable mb-0 bg-primary bg-opacity-10 text-primary rounded-2">
                                                        Renewal</p>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.member_category.edit', $item->id) }}">
                                                    <i class="text-primary" data-feather="edit"></i></a>


                                                <a class="delete-member-catgory"
                                                    href="{{ route('admin.member_category.delete', $item->id) }}"><i
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-member-catgory').on('click', function(e) {
                e.preventDefault();
                var deleteUrl = $(this).attr('href');
                var actionText = "Member Catgory";
