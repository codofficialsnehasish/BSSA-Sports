							...
							<div class="invoice-content-wrap" id="download_section">
								...
								<section class="ticket-booking-content" id="student_invoice">
									<div class="container">
										...
										<div class="table-wrapper pt-40">
											<table class="invoice-table student-invoice">
												...
												<tbody class="invo-tb-body">
													@php $total = 0; @endphp
													@foreach($entry_fees_structures as $item)
												...
												<table class="invo-total-table">
													<tbody>
														...
														<tr class="invo-grand-total bottom-border">
															...
															<td class="font-18-500 color-light-black text-right pt-20">₹{{ $data->paid_amount }}</td>
														</tr>
													</tbody>
												</table>
											</div>
										...
										<p style="text-align: left;color:black;">Rupees {{ numberToWords($data->paid_amount) }} only</p>
									</div>
								</section>
