            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Fees Categories</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-auto">
                ...
                <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                    <a href="{{ route('admin.fee_category.create') }}"><button class="btn btn-primary px-4"><i
                                ...
                                <tbody>
                                    ...
                                    @foreach ($categories as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.fee_category.edit', $item->id) }}">
                                                    <i class="text-primary" data-feather="edit"></i></a>


                                                <a class="delete-fees-catgory"
                                                    href="{{ route('admin.fee_category.delete', $item->id) }}"><i
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-fees-catgory').on('click', function(e) {
                e.preventDefault();
                var deleteUrl = $(this).attr('href');
                var actionText = "Fees Category";
