...
<div class="page-titles">
    <div class="d-flex align-items-center">
        ...
        <div class="custom-breadcrumb ml-auto">
            ...
            <a href="javascript:void(0);" class="breadcrumb">Collect Fees</a>
        </div>
    </div>
</div>
<!-- ============================================================== -->
        ...
        <div class="col s12">
            <div class="card">
                <div class="card-content">
                    <a href="{{ route('fees.index') }}" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Back</a>
                    <form class="h-form">
                        <div class="form-body">
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s3">
                                        <div class="h-form-label">
                                            <label for="full-n">Members</label>
                                        </div>
                                    </div>
