        ...
        <div class="row g-3">
            <div class="col-auto">
                <div class="position-relative">
                    <input class="form-control px-5" type="search" placeholder="Search Designations">
                    <span
            ...
            <div class="col-auto">
                ...
                <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                    <a href="{{ route('admin.designations.create') }}"><button class="btn btn-primary px-4"><i
                                        ...
                                        @foreach ($designations as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="delete-designations"
                                                        href="{{ route('admin.designations.delete', $item->id) }}"><i
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-designations').on('click', function(e) {
                e.preventDefault();
                var deleteUrl = $(this).attr('href');
                var actionText = "Designations";
