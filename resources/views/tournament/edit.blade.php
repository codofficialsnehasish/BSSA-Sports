...
@section('content')
    ...
    <div class="main-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Tournament</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="row">
            <form class="row g-3 needs-validation" novalidate action="{{ route('tournament.update',$tournament->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="tournament_name" placeholder="Enter Tournament Name" name="tournament_name" value="{{ $tournament->tournament_name }}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" id="registration_start_date" placeholder="Enter Registration Start Date" name="registration_start_date" value="{{ $tournament->registration_start_date }}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" id="registration_end_date" placeholder="Enter Registration End Date" name="registration_end_date" value="{{ $tournament->registration_end_date }}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="entry_fee" placeholder="Enter Entry Fee" name="entry_fee" value="{{ $tournament->entry_fee }}" required step="0.01">
                                        <div class="invalid-feedback">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <table width="100%" cellpadding="5" cellspacing="5" id="table_repeter">
                                        ...
                                        @foreach($entry_fees_structures as $entry_fees_structure)
                                        <tr>
                                            <td>{{ $entry_fees_structure->name }}</td>
                                            <td>{{ $entry_fees_structure->amount }}</td>
                                            <td>
                                                <a href="{{ route('tournaments.delete-fees-structure',$entry_fees_structure->id) }}"><i class="text-danger" data-feather="trash-2"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        <tr>
                            ...
                            <div class="card-body p-4">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="customRadioInline1" name="status" class="form-check-input" value="1" {{ check_uncheck($tournament->status,1) }}>
                                        <label class="form-check-label" for="customRadioInline1">Active</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="customRadioInline2" name="status" class="form-check-input" value="0" {{ check_uncheck($tournament->status,0) }}>
