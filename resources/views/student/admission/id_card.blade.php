                        ...
                        <div class="d-flex align-items-center justify-content-center text-center" id="PrintMe">
                            <div class="id-card-holder">
                                <div class="id-card">
                                    ...
                                    <h2>IDENTITY CARD</h2>
                                    <div class="photo">
                                        <img src="{{ isset($student->profile_image_media) ? asset('storage/' . $student->profile_image_media->file_path) : '' }}">
                                    </div>
                                    <h2>{{ $student->full_name }}</h2>
                                    <h3>Address: {{ $student->permanent_address }}</h3>
                                    <!-- <div class="qr-code">
                                        
                                    </div> -->
                                    {{-- <h3>ID : {{ $student->roll_no }}</h3> --}}
                                    <h3>Ph. No. : {{ $student->mobile_number }}</h3>
                                    <h3>DOB : {{ format_date($student->dob) }}</h3>
                                    {{-- <hr>
