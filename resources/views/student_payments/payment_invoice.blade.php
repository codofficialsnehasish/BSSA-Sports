									...
									<div class="container">
										...
										<div class="invo-car-book-wrap1 pt-40">
											<div class="booking-content-wrap" style="text-align: center;color:black;">
												...
												<p><strong>Received with thanks from {{ $student->full_name }}</strong></p>
												<p><strong>Date - {{ format_date($date) }}</strong></p>
												<p><strong>Receipt No. - {{ $StudentPaymentOrder->memo_no }}</strong></p>
											</div>
										</div>
										...
										<div class="table-wrapper pt-40">
											<table class="invoice-table student-invoice">
												...
												<tbody class="invo-tb-body">
													...
													<tr class="invo-tb-row @if(is_even($loop->iteration)) table-bg @endif">
														<td class="font-sm">{{ format_label($item->which_for) }} @if($item->which_for == 'monthly_fees') of {{ format_date_to_month($item->date) }} @endif</td>
												...
												<table class="invo-total-table">
													<tbody>
														...
														<tr class="invo-grand-total bottom-border">
															...
															<td class="font-18-500 color-light-black text-right pt-20">₹{{ $total }}</td>
														</tr>
													</tbody>
												</table>
											</div>
										...
										<p style="text-align: left;color:black;">Rupees {{ numberToWords($total) }} only</p>
									</div>
								</section>
